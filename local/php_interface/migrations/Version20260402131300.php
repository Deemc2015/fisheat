...
class Version20260402131300 extends Version
{
    protected $author = "admin";

    protected $description = "freeposition";
  ...
  'API_CODE' => 'free',
  'REST_ON' => 'Y',
  'NAME' => 'Бесплатно к позициям заказа',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Бесплатные позиции',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'ATT_FREE_PRODUCT',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'E',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    array (
      ...
      'IS_ENABLED' => 'N',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Кол-во для применения',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'ATT_COUNT_PRODUCT',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'N',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
