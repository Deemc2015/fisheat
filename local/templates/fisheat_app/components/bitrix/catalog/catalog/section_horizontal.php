...
if (isset($_COOKIE['sortten']) && $_COOKIE['sortten'] !== '') {
    $sort = $_COOKIE['sortten'];
} else {
    $sort = $arParams["ELEMENT_SORT_FIELD"];
}

if(isset($_COOKIE['sorttype']) && $_COOKIE['sorttype'] !== ''){
    $typeSort = $_COOKIE['sorttype'];
}
?>
