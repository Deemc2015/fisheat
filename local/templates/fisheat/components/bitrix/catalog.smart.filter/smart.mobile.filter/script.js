...
JCSmartFilter.prototype.setFilterButtonState = function(isEnabled) {
	var setFilterBtn = BX('set_filter');
	if (setFilterBtn) {
		setFilterBtn.disabled = !isEnabled;
		if (isEnabled) {
			BX.removeClass(setFilterBtn, 'disabled');
		} else {
			BX.addClass(setFilterBtn, 'disabled');
		}
	}
};
