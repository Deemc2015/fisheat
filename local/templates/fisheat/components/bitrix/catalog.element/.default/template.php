...
echo $APPLICATION->GetPageProperty("left_menu");
$templateLibrary = array('popup', 'fx', 'ui.fonts.opensans');
$currencyList = '';
if($arResult['PROPERTIES']['ATT_NEW']['VALUE'] == 'да'){
    $new = true;
}
if($arResult['PROPERTIES']['ATT_POPULAR']['VALUE'] == 'да'){
    $popular = true;
}
if($arResult['PROPERTIES']['ATT_OSTRO']['VALUE'] == 'да'){
    $hot = true;
}
if($arResult['PROPERTIES']['ATT_VEGAN']['VALUE'] == 'да'){
    $vegan = true;
}
...
<div class="bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	...
	<div class="container-detail-page">
		<div class="row">
			<div class="col-md-6 col-sm-12 left-detail-block">
			...
			<div class="col-md-6 col-sm-12 right-detail-block">
                <?if($arResult['NUTRITIONAL']):?>
                <div class="detail-block-info">
                    <div class="detail-block-info__detail">
                        <div class="detail-block-info__detail-text">
                            Пищевая ценность
                        </div>
                        <?if($arResult['NUTRITIONAL']['CALORIES']):?>
                            <div class="detail-block-info__detail-info"><span>Калории</span> <span><?=$arResult['NUTRITIONAL']['CALORIES']?></span></div>
                        <?endif?>

                        <?if($arResult['NUTRITIONAL']['BELKI']):?>
                            <div class="detail-block-info__detail-info"><span>Белки</span> <span><?=$arResult['NUTRITIONAL']['BELKI']?></span></div>
                        <?endif?>

                        <?if($arResult['NUTRITIONAL']['GIR']):?>
                            <div class="detail-block-info__detail-info"><span>Жиры</span> <span><?=$arResult['NUTRITIONAL']['GIR']?></span></div>
                        <?endif;?>

                        <?if($arResult['NUTRITIONAL']['YGLEVODY']):?>
			    ...
			    <?if($arResult['PROPERTIES']['ATT_SOSTAV']['VALUE']):?>
			        <div class="description-block">
        			    <div class="title-block-desc">Состав</div>
        			    <div class="text-block-desc"><p><?=$arResult['PROPERTIES']['ATT_SOSTAV']['~VALUE']['TEXT'];?></p></div>
			    <?endif;?>
			    
			     <?if($arResult['PROPERTIES']['ATT_RECOMENDATION']['VALUE']):?>
			        <div class="description-block">
										...
										<div class="main-button-container"  data-entity="main-button-container">
											<div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
												...
												if ($showAddBtn)
												{
                                                    ...
                                                    <div class="count-block-detail hidden" data-id="<?=$arResult['ID']?>">
