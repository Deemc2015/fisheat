...
class Ldo_develop extends CModule
{
    var $MODULE_ID = "ldo.develop";
    var $MODULE_VERSION;
    ...
    function __construct()
    {
        ...
        $this->MODULE_NAME = Loc::getMessage("LDO_DEVELOP_INSTALL_NAME");
        $this->MODULE_DESCRIPTION = Loc::getMessage("LDO_DEVELOP_INSTALL_DESCRIPTION");
        $this->PARTNER_NAME = Loc::getMessage('LDO_DEVELOP_PARTNER');
        $this->PARTNER_URI = Loc::getMessage('LDO_DEVELOP_PARTNER_URI');
    }
    ...
    protected function registerModuleHandlers(){
        ...
        $eventManager->registerEventHandlerCompatible(
            'sale', 'OnSaleBasketBeforeSaved',
            $this->MODULE_ID, '\Ldo\Develop\Basket', 'getData'
        );

        $eventManager->registerEventHandlerCompatible(
            'iblock', 'OnIBlockPropertyBuildList',
            $this->MODULE_ID, '\Ldo\Develop\Property', 'GetUserTypeDescription'
        );
