...
$ruleType = RuleTable::TYPE_BLACK;

$pageTitle = 'Черный список IP';
...
<div class="wrp"></div>
<div class="modalAdd">
    <div class="modal-title">Добавить IP в чёрный список</div>
    <p class="modal-subtitle">Посетители из чёрного списка сразу перенаправляются на страницу блокировки.</p>
  ...
  <path fill="none" stroke="#000000" stroke-width="2" d="M7,7 L17,17 M7,17 L17,7"/>
        ...
        <input type="hidden" class="ruleType" value="black">
    ...
    <form action="#" method="post" class="import-file" data-custom="1" data-rule-type="black">
...
<div class="modalEdit">
    ...
    <p class="modal-subtitle">Обновите адрес в чёрном списке.</p>
    <form action="#" method="post">
        <span class="close"><svg width="30px" height="30px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path fill="none" stroke="#000000" stroke-width="2" d="M7,7 L17,17 M7,17 L17,7"/>
</svg></span>
